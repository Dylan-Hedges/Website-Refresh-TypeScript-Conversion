...
export default function TypingAnimation(props) {
    ...
    return (<div className={styles.typingAnimationContainer}>
            <TypeAnimation sequence={sequenceConfig} wrapper="span" speed={1} className={styles.typingAnimation} repeat={Infinity}/>
        </div>);
}
